...
const App = () => {
    ...
    const onRmCart = (productId) => {
        const availableBeforeRm = availableProducts[productId]
        const inCartBeforeRm = inCartProducts[productId]
        if (inCartBeforeRm>0) {
        setAvailableProducts({
            ...availableProducts,
            [productId]: availableBeforeRm + 1,
        })
        
        setInCartProducts({
            ...inCartProducts,
            [productId]: inCartBeforeRm - 1,
        })}
    }
    // What is displayed. 
    ...
    return (
        <div className="d-flex justify-content-between">
            ...
            <Cart products={products} inCartProducts={inCartProducts} onRmCart={onRmCart}/>
        </div>
    )
}
